...
from sis.reports.operations_bundle_navigation import (
    quick_navigation,
    related_reports,
...
def test_quick_navigation_keeps_output_report_when_phase_gate_is_missing() -> None:
    assert quick_navigation(None, Path("data/reports/operations_bundle_manifest.md")) == {
...
def test_quick_navigation_uses_phase_gate_report_siblings() -> None:
    ...
    out_path = Path("data/reports/operations_bundle_manifest.md")
