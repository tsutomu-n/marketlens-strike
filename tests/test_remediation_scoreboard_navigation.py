...
from sis.reports.remediation_scoreboard_navigation import (
    quick_navigation,
    related_reports,
)
...
def test_quick_navigation_uses_scoreboard_report_siblings() -> None:
    out_path = Path("data/reports/remediation_scoreboard.md")
