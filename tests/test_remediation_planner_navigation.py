...
from sis.reports.remediation_planner_navigation import quick_navigation, related_reports


def test_remediation_planner_quick_navigation_uses_report_siblings() -> None:
    out_path = Path("data/reports/remediation_planner.md")
...
def test_remediation_planner_related_reports_uses_report_siblings() -> None:
    out_path = Path("data/reports/remediation_planner.md")
...
def test_remediation_planner_navigation_handles_missing_output_path() -> None:
