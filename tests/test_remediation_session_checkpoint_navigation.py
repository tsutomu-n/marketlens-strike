...
from sis.reports.remediation_session_checkpoint_navigation import (
    quick_navigation,
    related_reports,
)
...
def test_quick_navigation_uses_checkpoint_report_siblings() -> None:
    assert quick_navigation(Path("data/reports/remediation_session_checkpoint.md")) == {
...
def test_related_reports_uses_checkpoint_report_siblings() -> None:
    assert related_reports(Path("data/reports/remediation_session_checkpoint.md")) == {
        "remediation_session_checkpoint_report": "data/reports/remediation_session_checkpoint.md",
