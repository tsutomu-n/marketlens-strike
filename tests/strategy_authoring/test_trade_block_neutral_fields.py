...
def test_blocked_trade_neutral_fields_reset_trade_controls_and_preserve_groups() -> None:
    row = {
        "min_reward_risk_ratio": 1.5,
        "reward_risk_ratio": 2.0,
        "_cross_sectional_group": "sector-a",
        "_portfolio_group": "portfolio-a",
        "_portfolio_turnover_weight": -0.4,
    }

    assert _blocked_trade_neutral_fields(row) == {
        "stop_loss_bps": None,
