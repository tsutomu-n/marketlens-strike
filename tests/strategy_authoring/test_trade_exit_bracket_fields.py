...
def test_trade_exit_bracket_fields_resolve_defaults() -> None:
    assert _trade_exit_bracket_fields(row={}, exit_rules=_exit()) == {
        "stop_loss_bps": None,
        "min_stop_loss_bps": None,
        "max_stop_loss_bps": None,
        "take_profit_bps": None,
...
def test_trade_exit_bracket_fields_respect_overrides_before_columns() -> None:
    fields = _trade_exit_bracket_fields(
        row={
            "row_stop": 999.0,
            "row_min_stop": 80.0,
            "row_max_stop": 200.0,
    ...
    assert fields == {
        ...
        "partial_take_profit_bps": 100.0,
        "partial_exit_fraction": 0.25,
    }


def test_trade_exit_bracket_fields_use_regime_fallbacks() -> None:
    fields = _trade_exit_bracket_fields(
        row={},
        exit_rules=_exit(stop_loss_bps=150.0),
        regime=_regime(
            stop_loss_bps=90.0,
