...
from sis.commands.strategy_authoring_compare import register_strategy_authoring_compare_commands
from sis.commands.strategy_authoring_frameworks import (
    register_strategy_authoring_framework_commands,
)
from sis.commands.strategy_authoring_ledgers import register_strategy_authoring_ledger_commands
