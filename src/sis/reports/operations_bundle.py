...
def build_operations_bundle_manifest(
    *,
    ...
    monitoring = _safe_read_json(monitoring_summary_path)
    ops_review = _safe_read_json(ops_review_summary_path)
    dashboard = _safe_read_json(dashboard_summary_path)
    ...
    cycle_history = _safe_read_json(paper_cycle_history_summary_path)
