...
import polars as pl
from sis.reports import comparison_navigation
...
_dict_or_empty = comparison_navigation.dict_or_empty
_quick_navigation = comparison_navigation.quick_navigation
_related_reports = comparison_navigation.related_reports
