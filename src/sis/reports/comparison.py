...
def _related_reports(
    ...
    if isinstance(execution_summary, dict):
        items += (("execution_snapshot_report", execution_snapshot_flat_fields(
    ...
    if isinstance(execution_comparison, dict):
        items += (("execution_venue_comparison_report", execution_comparison_flat_fields(
    ...
    if isinstance(execution_diagnostics, dict):
        items += (("execution_venue_diagnostics_report", execution_diagnostics_flat_fields(
    ...
    if isinstance(execution_gap_history, dict):
        items += (("execution_gap_history_report", execution_gap_history_flat_fields(
    ...
    if isinstance(execution_state_comparison, dict):
        items += (("execution_state_comparison_report", execution_state_comparison_flat_fields(
    ...
    if isinstance(execution_snapshot_drift, dict):
        items += (("execution_snapshot_drift_report", execution_snapshot_drift_flat_fields(
    ...
    if isinstance(execution_drift_overview, dict):
        items += (("execution_drift_overview_report", execution_drift_overview_flat_fields(
