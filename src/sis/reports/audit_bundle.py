...
from sis.reports import audit_bundle_navigation
...
_report_path_for_summary = audit_bundle_navigation.report_path_for_summary
_quick_navigation = audit_bundle_navigation.quick_navigation
_related_reports = audit_bundle_navigation.related_reports
