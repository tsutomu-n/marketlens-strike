...
from sis.reports import evidence_navigation
...
_reports_dir = evidence_navigation.reports_dir
_quick_navigation = evidence_navigation.quick_navigation
_related_reports = evidence_navigation.related_reports
