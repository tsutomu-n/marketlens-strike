...
def render_operations_dashboard_markdown(
    summary: dict[str, Any],
    *,
    monitoring: dict[str, object] | None = None,
    ops_review_fields: dict[str, object] | None = None,
) -> str:
    quick_navigation = _string_dict(summary.get("quick_navigation"))
    related_reports = _string_dict(summary.get("related_reports"))
    recommended_read_order_items = _string_list(summary.get("recommended_read_order"))
    lines = [
    ...
    lines.extend(
        [
            "",
            *decision_state_section_lines(summary),
            "",
