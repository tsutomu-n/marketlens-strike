...
from sis.reports import operations_audit_pack_navigation
...
_report_path_for_summary = operations_audit_pack_navigation.report_path_for_summary
_quick_navigation = operations_audit_pack_navigation.quick_navigation
_related_reports = operations_audit_pack_navigation.related_reports
    ...
    manifest = {
        ...
        **phase_gate_fields,
        ...
        "artifacts": {
            ...
            "cycle_history_summary": str(cycle_history_summary_path)
            if cycle_history_summary_path
            else None,
