...
from sis.reports import weekly_review_current_gate
...
_current_gate_section_lines = weekly_review_current_gate.current_gate_section_lines
...
def build_weekly_review_report(
    *,
    ...
    if current_phase_gate_summary_path is not None:
        ...
        lines.extend(
            _current_gate_section_lines(
                current_phase_gate_summary_path, current_phase_gate, symbols
            )
        )
