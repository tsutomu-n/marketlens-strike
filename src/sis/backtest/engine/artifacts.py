    ...
    *,
    ...
    write_json(
        run_dir / "candidate_result.json",
        {
            ...
            "metrics": metrics,
            "fee_source_counts": metrics.get("fee_source_counts", {}),
            "fee_row_resolved_rate": metrics.get("fee_row_resolved_rate"),
            "fee_config_fallback_rate": metrics.get("fee_config_fallback_rate"),
            "fee_unresolved_rate_runtime": metrics.get("fee_unresolved_rate_runtime"),
