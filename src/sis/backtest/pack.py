...
def validate_strategy_backtest_pack(
    *,
    ...
    add_check(
        "external_framework_temporary_vectorbt",
        isinstance(temporary_allowed, list) and "vectorbt" in temporary_allowed,
        "temporary uv --with vectorbt smoke must remain the allowed external execution path",
    )
