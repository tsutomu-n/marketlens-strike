    ...
    *,
    ...
    for row in frame.to_dicts():
        signal = StrategySignalRecord(
            ...
            multi_leg_group_id=row.get("multi_leg_group_id"),
            multi_leg_leg_index=row.get("multi_leg_leg_index"),
            multi_leg_leg_count=row.get("multi_leg_leg_count"),
            multi_leg_anchor_real_market_symbol=row.get("multi_leg_anchor_real_market_symbol"),
            side=row["side"],
            ...
            exit_priority=row.get("exit_priority") or DEFAULT_EXIT_PRIORITY,
