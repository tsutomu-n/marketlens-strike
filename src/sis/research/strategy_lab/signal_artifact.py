...
STRATEGY_SIGNAL_SCHEMA: dict[str, Any] = {
    ...
    "multi_leg_group_id": pl.Utf8,
    "multi_leg_leg_index": pl.Int64,
    "multi_leg_leg_count": pl.Int64,
    "multi_leg_anchor_real_market_symbol": pl.Utf8,
    "side": pl.Utf8,
    ...
    "min_stop_loss_bps": pl.Float64,
    "max_stop_loss_bps": pl.Float64,
    "take_profit_bps": pl.Float64,
    "min_take_profit_bps": pl.Float64,
    "max_take_profit_bps": pl.Float64,
    "min_reward_risk_ratio": pl.Float64,
    "reward_risk_ratio": pl.Float64,
    "trailing_stop_bps": pl.Float64,
    "trailing_stop_activation_bps": pl.Float64,
    "partial_take_profit_bps": pl.Float64,
    "partial_exit_fraction": pl.Float64,
    "min_holding_minutes": pl.Int64,
    "max_holding_minutes": pl.Int64,
    "exit_priority": pl.Utf8,
    ...
    "max_capacity_usage_ratio": pl.Float64,
    "capacity_usage_ratio": pl.Float64,
    "max_correlation_crowding_score": pl.Float64,
    "correlation_crowding_score": pl.Float64,
