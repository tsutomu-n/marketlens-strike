...
| `docs/TRADE_XYZ_IMPLEMENTATION_STATUS_AUDIT_2026-05-28.md` | full check `294 passed` と PR12 runtime snapshot | focused historical Trade[XYZ] audit。current code/docs verification は `425 passed` / current-docs lint を使う |
