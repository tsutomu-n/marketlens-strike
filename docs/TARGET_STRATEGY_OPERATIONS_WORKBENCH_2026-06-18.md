...
8. Strategy Case Lite
9. Strategy Daily Brief
10. Micro Live Plan Gate
11. Micro Live Canary は最後。実行ではなく、まず計画と artifact contract から始める。
