...
実装を完了まで進めるための対象ファイル、テスト方針、完了条件は [STRATEGY_OPERATIONS_WORKBENCH_COMPLETION_PLAN_2026-06-19.md](STRATEGY_OPERATIONS_WORKBENCH_COMPLETION_PLAN_2026-06-19.md) を正本にする。この target definition だけでは、コーダーが全 task を完了できる粒度ではない。
...
- completion plan として [STRATEGY_OPERATIONS_WORKBENCH_COMPLETION_PLAN_2026-06-19.md](STRATEGY_OPERATIONS_WORKBENCH_COMPLETION_PLAN_2026-06-19.md) を追加済み。この文書だけで実装完了まで閉じるとは扱わない。
