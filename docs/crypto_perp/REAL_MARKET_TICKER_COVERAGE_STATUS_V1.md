...
現在のticker-covered eligible countはtargetと同じ`30`です。READYではありますがheadroomは0で、1 eventでもwindow/source validationから落ちればtarget未達へ戻ります。raw491 windowsのうちstrict candle contractで467がeligible、24がrejectです。
