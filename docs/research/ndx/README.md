...
この directory は NDX Layer 2.2 DAG foundation、Layer 2.3 preflight / feature panel / residual、Layer 2.4 residual validation gate の current docs 入口である。正本は `configs/research_layer_2_2/ndx/`、`configs/research_layer_2_3/ndx/`、`configs/research_layer_2_4/ndx/`、`src/sis/research/dag/`、`src/sis/research/ndx/`、`schemas/`、`tests/research/`、CLI help。
...
4. `2_2_IMPLEMENTATION_BOUNDARY.md`
5. `LAYER_2_2_IMPLEMENTATION_RECORD_2026-06-07.md`
6. `DATA_SOURCE_CONTRACT.md`
7. `05_TEMPORAL_AVAILABILITY.md`
8. `COUNTER_DAGS.md`
9. `04_CAUSAL_ROLES.md`
...
Layer 2.3/2.4 も `strategy_signals.parquet`、backtest、paper candidate、`PaperIntentPreview`、paper/live order、external API、credentials、dependency追加、NQ / VXN / SOX direct / options / gamma input を扱わない。
