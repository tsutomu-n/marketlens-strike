...
### 11. Execution / Paper / Bot系の状態確認ができる
...
### 13. Operations / Audit / Remediationを作れる
...
`marketlens-strike` は、個人システムトレーダーが戦略を雑に本番投入しないための、CLI中心の研究・backtest・review・paper観察・安全gate作業台です。
