...
- Strategy backtest comparison, suite, adapter spike, external result, pack, and pack validation commands: `strategy-backtest-compare`, `strategy-backtest-suite`, `strategy-backtest-adapter-spike`, `strategy-backtest-external-run`, `strategy-backtest-pack`, `strategy-backtest-pack-validate`
