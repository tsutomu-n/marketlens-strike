...
- Strategy backtest comparison, suite, adapter spike, external result, portfolio comparison, metric extension, report extension, stress, regime split, pack, and pack validation commands: `strategy-backtest-compare`, `strategy-backtest-suite`, `strategy-backtest-adapter-spike`, `strategy-backtest-external-run`, `strategy-backtest-portfolio-compare`, `strategy-backtest-metric-extension`, `strategy-backtest-report-extension`, `strategy-backtest-stress`, `strategy-backtest-regime-split`, `strategy-backtest-pack`, `strategy-backtest-pack-validate`
