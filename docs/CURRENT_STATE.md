...
- アプリの全体像は [APP_CURRENT_STATE_OVERVIEW_2026-07-05.md](APP_CURRENT_STATE_OVERVIEW_2026-07-05.md)、用語は [APP_TERMS_GLOSSARY_2026-07-05.md](APP_TERMS_GLOSSARY_2026-07-05.md)、実装 surface / artifact reference は [CURRENT_ARTIFACT_SURFACE_REFERENCE_2026-07-05.md](CURRENT_ARTIFACT_SURFACE_REFERENCE_2026-07-05.md) を読む。
...
- actual cash なしの Crypto Perp 短期終着点は [crypto_perp/BACKTEST_CANDIDATE_PACK_V1.md](crypto_perp/BACKTEST_CANDIDATE_PACK_V1.md) を読む。2026-07-04 の progress-to-90 / pre-actual-cash docs は archive 済みの historical snapshot です。
- pre-actual-cash の短期境界は、公開 candle のみ、1 event、`NO_TRADE` leader、`selected_action=UNKNOWN`、bias guard sample insufficient を利益証拠ではなく候補分類材料として扱うこと。分類先は `KILL` / `REVISE_EVENT_DEFINITION` / `COLLECT_MORE_SOURCES` / `HOLD_FOR_FUTURE_ACTUAL_CASH` に限定する。
...
- `crypto-perp-backtest-candidate-pack` は actual cash なしの timestamp-safe simulation evidence pack を作る入口。`BACKTEST_REJECT` / `BACKTEST_REVISE` / `BACKTEST_COLLECT_MORE_DATA` / `BACKTEST_CANDIDATE_HOLD` に分類するが、profit proof、paper permission、tiny-live readiness、live readiness ではない。
...
| アプリの全体像を読む | [APP_CURRENT_STATE_OVERVIEW_2026-07-05.md](APP_CURRENT_STATE_OVERVIEW_2026-07-05.md) |
| 用語を確認する | [APP_TERMS_GLOSSARY_2026-07-05.md](APP_TERMS_GLOSSARY_2026-07-05.md) |
| 実装 surface / artifact の入口を読む | [CURRENT_ARTIFACT_SURFACE_REFERENCE_2026-07-05.md](CURRENT_ARTIFACT_SURFACE_REFERENCE_2026-07-05.md) |
...
| Crypto Perp の actual-cashなし短期終着点を読む | [crypto_perp/BACKTEST_CANDIDATE_PACK_V1.md](crypto_perp/BACKTEST_CANDIDATE_PACK_V1.md) |
...
3. [APP_CURRENT_STATE_OVERVIEW_2026-07-05.md](APP_CURRENT_STATE_OVERVIEW_2026-07-05.md)
4. [APP_TERMS_GLOSSARY_2026-07-05.md](APP_TERMS_GLOSSARY_2026-07-05.md)
5. [CURRENT_ARTIFACT_SURFACE_REFERENCE_2026-07-05.md](CURRENT_ARTIFACT_SURFACE_REFERENCE_2026-07-05.md)
6. [AGENT_ASSESSMENT_INDIVIDUAL_TRADER_2026-06-20.md](AGENT_ASSESSMENT_INDIVIDUAL_TRADER_2026-06-20.md)
7. [AGENT_ASSESSMENT_PRACTICAL_DECISION_NOTE_2026-06-20.md](AGENT_ASSESSMENT_PRACTICAL_DECISION_NOTE_2026-06-20.md)
8. [AI_AGENT_STRATEGY_BACKTEST_GUIDE.md](AI_AGENT_STRATEGY_BACKTEST_GUIDE.md)
9. [STRATEGY_AND_BACKTEST_USER_GUIDE.md](STRATEGY_AND_BACKTEST_USER_GUIDE.md)
10. [FEATURE_CAPABILITY_SUMMARY_2026-06-27.md](FEATURE_CAPABILITY_SUMMARY_2026-06-27.md)
11. [strategy_idea_candidates/NON_TECHNICAL_OVERVIEW_2026-06-28.md](strategy_idea_candidates/NON_TECHNICAL_OVERVIEW_2026-06-28.md)
12. [STRATEGY_IDEA_GENERATION_RESEARCH_2026-06-27.md](STRATEGY_IDEA_GENERATION_RESEARCH_2026-06-27.md)
13. [STRATEGY_IDEA_GENERATION_PRE_IMPLEMENTATION_AUDIT_2026-06-27.md](STRATEGY_IDEA_GENERATION_PRE_IMPLEMENTATION_AUDIT_2026-06-27.md)
14. [STRATEGY_IDEA_CANDIDATE_PIPELINE_CHECKPOINTS_2026-06-27.md](STRATEGY_IDEA_CANDIDATE_PIPELINE_CHECKPOINTS_2026-06-27.md)
15. [strategy_idea_candidates/README.md](strategy_idea_candidates/README.md)
16. [STRATEGY_IDEA_GENERATION_DEPENDENCY_RESEARCH_2026-06-27.md](STRATEGY_IDEA_GENERATION_DEPENDENCY_RESEARCH_2026-06-27.md)
17. [REPO_CAPABILITIES_PLAIN_JA_2026-06-17.md](REPO_CAPABILITIES_PLAIN_JA_2026-06-17.md)
18. [CODE_STATUS.md](CODE_STATUS.md)
19. [IMPLEMENTED_SURFACES.md](IMPLEMENTED_SURFACES.md)
20. [NEXT_DIRECTION_CURRENT.md](NEXT_DIRECTION_CURRENT.md)
21. [CURRENT_DOCS_AND_STRUCTURE_TRIAGE_2026-06-27.md](CURRENT_DOCS_AND_STRUCTURE_TRIAGE_2026-06-27.md)
22. [backtest/README.md](backtest/README.md)
23. [strategy_review/README.md](strategy_review/README.md)
24. [strategy_review/OPERATOR_REVIEW_PACKET_RECIPE.md](strategy_review/OPERATOR_REVIEW_PACKET_RECIPE.md)
25. [research/ndx/README.md](research/ndx/README.md)
26. [strategy_lifecycle/README.md](strategy_lifecycle/README.md)
27. [OPERATIONS_RUNBOOK.md](OPERATIONS_RUNBOOK.md)
28. [crypto_perp/BACKTEST_CANDIDATE_PACK_V1.md](crypto_perp/BACKTEST_CANDIDATE_PACK_V1.md)
29. [plan/README.md](../plan/README.md)
