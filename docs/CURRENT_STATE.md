...
- Strategy backtest comparison, suite, adapter spike, external result, portfolio comparison, metric extension, pack, and pack validation commands: `strategy-backtest-compare`, `strategy-backtest-suite`, `strategy-backtest-adapter-spike`, `strategy-backtest-external-run`, `strategy-backtest-portfolio-compare`, `strategy-backtest-metric-extension`, `strategy-backtest-pack`, `strategy-backtest-pack-validate`
