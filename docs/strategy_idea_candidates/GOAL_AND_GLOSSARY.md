...
- `BRIDGED`: authoring spec 生成、candidate-scoped suite / bundle 生成、標準 backtest pack 生成、backtest pack validation が候補スコープで完了。
