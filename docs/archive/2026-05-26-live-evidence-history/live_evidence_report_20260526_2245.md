...
- started_at_utc: `2026-05-26T13:45:00Z`
- finished_at_utc: `2026-05-26T13:47:00Z`
...
- planner_next_best_command: `uv run sis refresh-operations-artifacts`
- planner_feedback_priority_reason: `evaluation_failed`
- execution_plan_status: `stalled`
- execution_plan_next_action_command: `uv run sis monitoring-status`
- execution_plan_feedback_priority_reason: `evaluation_failed`
- session_status: `ready_for_dry_run`
- session_next_pending_command: `uv run sis phase-gate-review`
- session_feedback_priority_reason: `evaluation_failed`
- checkpoint_status: `in_progress`
- checkpoint_next_action_command: `uv run sis phase-gate-review`
- checkpoint_feedback_priority_reason: `evaluation_failed`
- scoreboard_status: `in_progress`
- scoreboard_next_action_command: `uv run sis phase-gate-review`
- scoreboard_feedback_priority_reason: `evaluation_failed`
...
- evidence_card: `data/evidence/evidence_card_20260525_125425.json`
