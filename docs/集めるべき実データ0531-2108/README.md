...
yfinance由来のreference barsを収集できる。
...
SIS_TRADE_XYZ_CYCLE_SYMBOLS=AAPL,AMD,AMZN,EWJ,GOOGL,META,MSFT,NVDA,SP500,TSLA,XYZ100
...
SIS_TRADE_XYZ_CYCLE_SIGNAL_CANDLE_INTERVALS=30m,4h,1d,3d
SIS_TRADE_XYZ_CYCLE_SIGNAL_CANDLE_PERIOD_DAYS=365
SIS_TRADE_XYZ_CYCLE_SIGNAL_CANDLE_MAX_AGE_HOURS=24
