...
| Path | 理由 | 推奨更新 |
|---|---|---|
| `README.md` | read-first と verification 値の入口 | audit 正本を本ファイルへ差し替え、`596 passed` / current docs `78` 件へ更新 |
| `docs/CURRENT_STATE.md` | current truth の入口 | Strategy authoring command list に `strategy-author-train-model` を追加し、検証値を更新 |
| `docs/CODE_STATUS.md` | 実装状態一覧 | verification を 2026-05-31 / `596 passed` / current docs `78` 件へ更新 |
| `docs/strategy_research_lab/08_CURRENT_CAPABILITIES.md` | capabilities の current entry | check 結果を `596 passed` / current docs `78` 件へ更新 |
| `docs/strategy_research_lab/11_STRATEGY_AUTHORING_CURRENT_SUMMARY.md` | authoring の現状説明 | check 結果を `596 passed` / current docs `78` 件へ更新 |
