...
| Backtest candidate pack | implemented as local timestamp-safe simulation evidence pack; classifies candidates without actual cash and never promotes to live | `crypto-perp-backtest-candidate-pack`, `src/sis/crypto_perp/backtest_candidate_pack.py`, `schemas/crypto_perp_backtest_candidate_pack.v1.schema.json`, `tests/crypto_perp/test_backtest_candidate_pack.py` |
