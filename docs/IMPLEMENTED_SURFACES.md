...
| Pre-actual-cash evidence pack gate | implemented as local multi-event/outcome aggregation and 4-choice candidate classification, not profit proof | `crypto-perp-pre-actual-cash-evidence-pack`, `src/sis/crypto_perp/pre_actual_cash.py`, `schemas/crypto_perp_pre_actual_cash_decision.v1.schema.json`, `tests/crypto_perp/test_profit_readiness_local_automation.py` |
